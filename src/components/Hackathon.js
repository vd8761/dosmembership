        ...
        <section className="section" style={{ position: 'relative', overflow: 'hidden', backgroundColor: '#0f172a', color: 'white' }}>
            ...
            <div className="container" style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '3rem', fontWeight: '800', marginBottom: '20px', color: 'white' }}>
                    Non-Stop <span style={{ color: 'var(--primary)' }}>Hackathon</span>
                </h2>
                
                <p style={{ fontSize: '1.2rem', color: '#94a3b8', maxWidth: '700px', margin: '0 auto 40px', lineHeight: '1.7' }}>
                    Put your skills to the ultimate test. At the end of the Fellowship, join our intensive hackathon. Form a team, build a complete AI product from scratch, and pitch it to industry judges.
                </p>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '30px' }}>
                    ...
                    <div style={{ flex: '1 1 250px', maxWidth: '350px', background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.1)', padding: '30px 25px', borderRadius: '16px' }}>
                        ...
                        <h3 style={{ fontSize: '1.2rem', marginBottom: '10px', color: 'white' }}>Global Opportunity</h3>
                        <p style={{ color: '#94a3b8', fontSize: '0.95rem', lineHeight: '1.6' }}>Secure an overseas internship/placement opportunity.</p>
                    </div>
                </div>
